 ...
 * @generated
 */
public class Kamp4hmiModelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Kamp4hmiModelPackage.STEP: {
			...
			case Kamp4hmiModelPackage.ACTOR_STEP: {
			...
			case Kamp4hmiModelPackage.SYSTEM_STEP: {
			...
			case Kamp4hmiModelPackage.MODE: {
				Mode mode = (Mode)theEObject;
				T result = caseMode(mode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Kamp4hmiModelPackage.REPOSITORY: {
				Repository repository = (Repository)theEObject;
				T result = caseRepository(repository);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Kamp4hmiModelPackage.IF: {
			...
			case Kamp4hmiModelPackage.CONDITION: {
