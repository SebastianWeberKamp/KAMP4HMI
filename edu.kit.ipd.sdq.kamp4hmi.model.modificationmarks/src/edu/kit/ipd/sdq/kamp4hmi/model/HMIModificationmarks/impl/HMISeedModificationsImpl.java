...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>HMI Seed Modifications</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.kamp4hmi.model.HMIModificationmarks.impl.HMISeedModificationsImpl#getActorStepModification <em>Actor Step Modification</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4hmi.model.HMIModificationmarks.impl.HMISeedModificationsImpl#getSystemStepModification <em>System Step Modification</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HMISeedModificationsImpl extends AbstractSeedModificationsImpl implements HMISeedModifications {
	/**
	 ...
	 * @generated
	 */
	protected HMISeedModificationsImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return HMIModificationmarksPackage.Literals.HMI_SEED_MODIFICATIONS;
	}
	...
	public EList<HMIModifyActorStep> getActorStepModification() {
		if (actorStepModification == null) {
			actorStepModification = new EObjectContainmentEList<HMIModifyActorStep>(HMIModifyActorStep.class, this, HMIModificationmarksPackage.HMI_SEED_MODIFICATIONS__ACTOR_STEP_MODIFICATION);
		}
	...
	public EList<HMIModifySystemStep> getSystemStepModification() {
		if (systemStepModification == null) {
			systemStepModification = new EObjectContainmentEList<HMIModifySystemStep>(HMIModifySystemStep.class, this, HMIModificationmarksPackage.HMI_SEED_MODIFICATIONS__SYSTEM_STEP_MODIFICATION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case HMIModificationmarksPackage.HMI_SEED_MODIFICATIONS__ACTOR_STEP_MODIFICATION:
				return ((InternalEList<?>)getActorStepModification()).basicRemove(otherEnd, msgs);
			case HMIModificationmarksPackage.HMI_SEED_MODIFICATIONS__SYSTEM_STEP_MODIFICATION:
